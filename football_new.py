...
def post_soccer_news():
    ...
    try:
        ...
        prompt = (
            ...
            "يجب أن يكون النص باللغة العربية الفصحى فقط مع إمكانية وجود أسماء الأندية واللاعبين بالإنجليزية. "
            "إليك الأخبار:\n\n" + raw_combined +
    ...
    fallback_hashtags = "#كرة_القدم #أخبار_الكرة #مباريات #الدوري_الإنجليزي #الدوري_الإسباني"
